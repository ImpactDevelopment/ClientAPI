...
public class CFont {
    ...
    CFont(Font font, boolean antiAlias, boolean fractionalMetrics) {
        this.font = font;
    ...
    DynamicTexture setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, CharData[] chars) {
    ...
    void drawChar(CharData[] chars, char c, float x, float y) throws ArrayIndexOutOfBoundsException {
        try {
