...
/**
 * @author Brady
 * @since 9/10/2017 4:19 PM
 */
@Mixin(SPacketWindowProperty.class)
public interface ISPacketWindowProperty {

    @Accessor int getWindowId();

    @Accessor void setWindowId(int windowId);

    @Accessor int getProperty();

    @Accessor void setProperty(int property);
