...
public interface IEntity {
	...
	/**
	 * Calculates the predicted position that an entity will be in the specified
	 * amount of ticks
	 *
	...
	/**
	 * Sets all forms of position and rotation in this entity to the specified
	...
	/**
	 * Sets all forms of position of rotation to their specified vectors
	 *
	 * @param pos The position
	 ...
	 */
	default void setAll(Vec3 pos, Vec3 prev, Vec3 lastTick, Vec2 angles,
	    Vec2 prevAngles) {
		this.setPos(pos);
