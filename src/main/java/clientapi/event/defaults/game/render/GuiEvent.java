...
/**
 * Called when a Gui Screen is displayed. The screen can be overriden by using
 * the {@code setScreen(GuiScreen)} method, which will completely override the
 * screen that would've been displayed.
 *
 * @author Brady
