...
public interface Widget extends Helper {
    ...
    /**
     * Renders this widget on a screen with the specified scaled resolution
     * using the specified font renderer.
     *
    ...
    /**
     * Sets the width of the widget. This should be called after the widget has
     * been rendered to let the handler know the updated bounds of the widget.
     *
    ...
    /**
     * Sets the height of the widget. This should be called after the widget has
     * been rendered to let the handler know the updated bounds of the widget.
     *
    ...
    /**
     * Sets the visibility flag of the widget. If this is set to false, then the
