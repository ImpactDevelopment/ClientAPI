...
public enum DefaultWidgetPos implements WidgetPos, Helper {
	...
	LEFT_TOP(0.0F, 0.0F, 0.0F), LEFT_MIDDLE(0.0F, 0.5F, -0.5F),
	LEFT_BOTTOM(0.0F, 1.0F, -1.0F),

	CENTER_TOP(0.5F, 0.0F, 0.0F), CENTER_MIDDLE(0.5F, 0.5F, -0.5F),
	CENTER_BOTTOM(0.5F, 1.0F, -1.0F),

	RIGHT_TOP(1.0F, 0.0F, 0.0F), RIGHT_MIDDLE(1.0F, 0.5F, -0.5F),
