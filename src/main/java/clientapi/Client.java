...
import clientapi.module.plugin.Plugin;
import clientapi.module.plugin.PluginLoader;
...
/**
 * The base for all ClientAPI Clients. The classpath of implementations of
 * {@code Client} should be defined in the {@code client.json} file.
 *
 * @see ClientInfo
 * @author Brady
...
public abstract class Client implements Helper {
	 ...
	 * @see Module
	 * @see Plugin
	 * @param handler The handler that's being used to handle Client API
	 *            internal events
	 */
	...
	/**
	 * Returns all of the PluginLoaders. Usually used for loading the Modules
	 * from the Plugins
	 *
	...
	/**
	 * Returns all of the Plugins from all of the PluginLoaders. Cleaner way of
	 * getting a list of all of the Plugins.
	 *
	...
	public List<Plugin> getPlugins() {
		...
		this.pluginLoaders
		    .forEach(loader -> plugins.addAll(loader.getPlugins()));
		return plugins;
	}
}
