...
public final class Vec3 {
	...
	/**
	 * Transfers the X/Y/Z from another Vec3 and sets this Vec3's X/Y/Z to it
	 *
	 * @return This Vec3
	 */
	...
	/**
	 * Calculates the angles that an entity at this position would have to look
	 * at to look at the specified Vec3.
	 *
	...
	public final Vec2 rotationsTo(Vec3 vec) {
		...
		return new Vec2(Math.toDegrees(Math.atan2(diff[2], diff[0])) - 90.0F,
