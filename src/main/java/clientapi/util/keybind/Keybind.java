...
public final class Keybind {
    ...
    /**
     * Called when the key's state has been changed, indicating that an action
     * should take place
     */
    ...
    public enum Type {
        /**
         * Calls onClick whenever the defined keycode's state is changed from
         * false to true, indicating that the key was pressed.
         */
        TOGGLE,

        /**
         * Call onClick whenever the defined keycode's state is changed,
         * indicating that the key was being held/released, and that changed.
         */
        HOLD
    }
