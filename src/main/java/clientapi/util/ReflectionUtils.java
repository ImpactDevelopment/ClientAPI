...
/**
 * Util file used to clean up usages of the reflection api throughout the client
 * api
 *
 * @author Brady
...
public final class ReflectionUtils {
     ...
     */
    public static boolean setField(Object object, String fieldName,
        Object value) {
        Field field = Arrays.stream(object.getClass().getDeclaredFields())
            .filter(f -> f.getName().equals(fieldName)).findFirst()
            .orElse(null);
    ...
    /**
     * Gets a method from the specified object with the specified name and
     * parameters
     *
