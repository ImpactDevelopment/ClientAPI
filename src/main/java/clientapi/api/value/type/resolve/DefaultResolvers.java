...
package clientapi.api.value.type.resolve;

import clientapi.api.util.ReflectionUtils;
import clientapi.api.value.annotation.NumberValue;
import clientapi.api.value.type.MultiType;
import clientapi.api.value.type.NumberType;
import clientapi.api.value.type.StringType;
import clientapi.api.util.annotation.Label;
import clientapi.api.value.annotation.MultiValue;
import clientapi.api.value.type.BooleanType;
